...
(use-package blame-reveal
  ...
  ;; Display
  (setq blame-reveal-header-position 'before-block)
...
#+begin_src elisp
;; Header position
(setq blame-reveal-header-position 'before-block)     ; Above first line
(setq blame-reveal-header-position 'after-first-line) ; Inline

;; Fringe side
(setq blame-reveal-style 'left-fringe)   ; Left (default)
(setq blame-reveal-style 'right-fringe)  ; Right
...
;; Default formatter is blame-reveal-format-header-default
#+end_src
